...
const Tontines = () => {
  ...
  return (
    <div className="animate-fade">
      ...
      {tontines.length === 0 ? (
        <div className="glass-panel animate-fade" style={{ padding: '40px 24px', textAlign: 'center', maxWidth: '600px', margin: '0 auto' }}>
        ...
        <div className="responsive-grid">
          {tontines.map((t, i) => (
            <div 
              key={t.id} 
              className={`glass-panel animate-slide-up stagger-${(i % 4) + 1}`}
      ...
      <React.Fragment>
          ...
          <div className="modal-overlay">
            <div className="glass-panel modal-content animate-fade" style={{ padding: '32px', border: '1px solid rgba(255,255,255,0.15)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                <h2 style={{ fontSize: '24px', margin: 0 }}>Nouvelle Tontine</h2>
              ...
              <form onSubmit={handleCreate}>
                ...
                <div className="input-group">
                  <label>Montant par personne (FCFA)</label>
                  <input 
        ...
        {isJoinModalOpen && (
          <div className="modal-overlay">
            <div className="glass-panel modal-content animate-fade" style={{ padding: '32px', border: '1px solid rgba(255,255,255,0.15)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                <h2 style={{ fontSize: '24px', margin: 0 }}>Rejoindre un groupe</h2>
